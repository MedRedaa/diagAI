    ...
    <div className="mt-16">
      <div className="flex space-x-44">
        <div>
          ...
          <div className="w-[120px] mt-2 h-[4px]  dark:bg-darkPrimary"style={{background:"#009999"}}></div>
          <div className="mt-10">
            <div className="mb-10">
          ...
          <div className="mt-2">
            ...
            <div className="mt-5 text-sm flex space-x-3 items-center">
              <button
                ...
                className="bg-primary p-1 disabled:bg-opacity-40 px-4 text-white  rounded-md text-sm" style={{background:"#009999",width:200,height:40}}
                onClick={handleAdd}
              >
                Add
              </button>
              <button
                ...
                className="p-[3px] disabled:text-white disabled:border-none px-4 text-primary border-[1px] border-primary rounded-md" style={{background:"#009999",width:300,height:40}}
              >
                Run Diagnosis
              </button>
            </div>
