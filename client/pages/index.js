    ...
    <div className="flex justify-between" >
      <div className="p-16">
        <div onClick={()=>setDarkMode(prev=>!prev)} className="cursor-pointer">
          <Image src={!darkMode?"/logo.png":"/logo.png"} height="100px" width="200px" />
        </div>
        <div className={`${isLogin?'mt-28':'mt-16'}`} style={{marginLeft:600}}>
          ...
          >
            {error
              ? error
              : "Accessing DiagAI's benefits requires logging in."}
          </div>
          ...
          <div className="mt-10 space-y-5">
            ...
            <div>
              <div
                ...
                style={{ width : isLogin?'370px':'510px',background:"#009999"}}
                className="mt-7 dark:bg-darkPrimary cursor-pointer text-white  h-[37px] transition-all flex items-center justify-center rounded-md"
          ...
          <div className="mt-5 text-sm">
            ...
            <span className=" dark:text-darkPrimary transition-all cursor-pointer font-semibold" style={{color:"#009999"}} onClick={()=>setIsLogin(!isLogin)}>{isLogin?'Sign Up':'Login'}</span>
          </div>
        </div>
      </div>
      <div></div>
