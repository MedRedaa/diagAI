  ...
  const handleSave = async()=>{
    ...
    return (
        ...
        <div className="mt-8 flex space-x-3 justify-end">
               <button  className="border-[#009999] bg-transparent disabled:bg-opacity-90 text-[#009999] border-2 hover:scale-105 transition-all ease-out text-sm px-2 py-2 rounded-md" onClick={()=>alert('Detected!!')}>Detect Location</button>
              <button onClick={handleSave}   className="bg-[#009999] disabled:bg-opacity-90 text-white text-sm px-2 py-2 rounded-md">Save and Continue</button>
          </div>
        </>
    )
}
