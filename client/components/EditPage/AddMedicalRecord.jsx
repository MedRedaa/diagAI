  ...
  return (
    <Modal show={show} onClose={onClose} title={'Add Medical Record'} >
        <div className='mt-5 flex space-x-2 items-center'>
            <button onClick={()=>ref.current.click()} className='bg-[#009999] px-3 text-sm py-1 rounded-md text-white'>{loading?'Loading...':'Add File'}</button>
        ...
        />
        <button onClick={handleSave} disabled={loading} className='mt-5 text-sm border-[#009999] border-2 rounded-md text-[#5A5482] hover:bg-[#009999] hover:text-white transition-all px-2 py-1  w-fit'>{loading?'Loading...':'Save'}</button>
